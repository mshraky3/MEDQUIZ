...
const Payment = () => {
  ...
  const plans = [
    {
      id: 'special',
      name: 'اشتراك سنوي - سعر تمهيدي',
      price: '٧٥ ريال',
      originalPrice: '١٢٥ ريال',
      period: 'السعر الحالي متاح حتى الإطلاق الرسمي',
      features: [
        'الوصول إلى جميع الأسئلة',
        'تحليلات مفصلة',
        'تتبع التقدم',
        'دعم فني',
        'سعر تمهيدي محدود قبل الزيادة إلى ١٢٥ ريال',
        'عرض متاح أثناء تحسين التطبيق',
  ...
  return (
    <div className="payment-page">
      <div className="payment-header">
        ...
        <h1>اشتراك سنوي - سعر تمهيدي محدود</h1>
        <p className="payment-subtitle">
          احصل على الوصول الكامل الآن بـ ٧٥ ريال قبل أن يرتفع السعر إلى ١٢٥ ريال بعد الإطلاق الرسمي
        </p>
      </div>
        ...
        <div className="plan-highlight">
          ...
          <div className="plan-pricing">
            <div className="price-display">
              ...
              <span className="original-price">١٢٥ ريال</span>
            </div>
            <div className="savings-badge">
              السعر سيرتفع إلى ١٢٥ ريال بعد اكتمال التطبيق
            </div>
            <div className="period-text">
              استغل السعر الحالي أثناء مرحلة التحسين
            </div>
          </div>
