        ...
        },
        {
            ...
            summaryHtml: `
                ...
                <section class="topic deck-enrich">
                    <h3>Study-deck deep dive</h3>
                    <p class="deck-intro">Every comparison table, animated algorithm and clinical pearl from the high-yield SMLE deck for this topic.</p>
<h4 class="deck-topic">Indications of endoscopy</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>New onset of dyspepsia in patient &gt;60 years</li><li>Evidence of GI bleeding (Hematemesis, melena)</li><li>Iron deficiency anemia</li><li>Anorexia or unexplained weight loss</li><li>Persistent vomiting</li><li>Gastrointestinal cancer in 1 st degree relative</li></ul></div></div><h4 class="deck-topic">Approach to dysphagia</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Sleeping on the stomach side</li><li>Soft bedding or overheating</li><li>Maternal smoke during pregnancy</li><li>Premature infant or low birth weight</li></ul></div><div class="deck-card mgmt"><span class="deck-card-h">Management</span><ul><li>Place baby on back to sleep (Best strategy)</li><li>Use a firm mattress</li><li>Keep sleeping area separate to the parents but in the same room</li><li>Pacifier at bed time</li></ul></div></div><h4 class="deck-topic">Mallory Weiss syndrome</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Definition: UGIB caused by tear at the gastro-esophageal junction</li><li>May be asymptomatic</li><li>Epigastric or backpain</li><li>Hematemesis preceded by forceful or repeated vomiting</li></ul></div><div class="deck-card diag"><span class="deck-card-h">Diagnosis · best test</span><ul><li>Esophagogastroduodenoscopy Gold standard (indicated to all patients)</li><li>If the patient actively bleeding UGIB Treatment</li><li>If the patient not-actively bleeding Conservative management (PPI, antiemetics)</li></ul></div></div><h4 class="deck-topic">Boerhaave's syndrome</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Pathophysiology: Severe vomiting/ high intrathoracic pressure Transmural perforation</li><li>Mackler triad: Vomiting/retching, Retrosternal Chest pain, Subcutaneous or mediastinal emphysema</li><li>Dysphagia</li><li>Dyspnea, tachypnea, tachycardia</li></ul></div><div class="deck-card diag"><span class="deck-card-h">Diagnosis · best test</span><ul><li>Chest X-ray Widened or pneumomediastinum, pneumothorax, pneumoperitoneum</li><li>Neck X-ray SC emphysema</li><li>Contrast esophagography Contrast leak at the site of perforation</li><li>Treatment (See next slide)</li></ul></div></div><h4 class="deck-topic">Esophageal cancer</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Adenocarcinoma (Lower esophagus) Barret's esophagus, GERD, Male, 50-60 Age</li><li>Squamous cell carcinoma (Upper esophagus) Achalasia, Smoking, Alcohol.</li><li>General signs: Unintentional weight loss, Dyspepsia, Signs of anemia</li><li>Signs of Advanced disease: Progressive dysphagia, retrosternal chest pain, hoarssness</li><li>Cervical lymphadenopathy</li><li>Upper gastrointestinal bleeding: Hematemesis, melena</li></ul></div><div class="deck-card diag"><span class="deck-card-h">Diagnosis · best test</span><ul><li>EGD with biopsy initial and confirmatory test</li><li>Staging CT Chest/Abdomen with IV contrast</li><li>Treatment According to the stage:<ul class="sub"><li>Esophageal resection High grade dysplasia, non-metastasized tumors</li><li>Neoadjuvant chemotherapy Locally advanced disease followed by surgery</li><li>Palliative distant metastatic tumor</li></ul></li></ul></div></div><h4 class="deck-topic">Peptic Ulcer disease</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Definition: UGIB caused by tear at the gastro-esophageal junction</li><li>May be asymptomatic</li><li>Epigastric or backpain</li><li>Hematemesis preceded by forceful or repeated vomiting</li></ul></div><div class="deck-card diag"><span class="deck-card-h">Diagnosis · best test</span><ul><li>Esophagogastroduodenoscopy Gold standard (indicated to all patients)</li><li>If the patient actively bleeding UGIB Treatment</li><li>If the patient not-actively bleeding Conservative management (PPI, antiemetics)</li></ul></div></div><h4 class="deck-topic">Perforated Viscus &amp; peritonitis</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Sudden severe abdominal pain (epigastric &amp; radiated to the back incase of PUD)</li><li>Rigidity, Rebound tenderness</li><li>Absent bowel sounds</li><li>Tachycardia, Hypotension</li><li>Erect CXR Free air under diaphragm</li><li>Abdominal X-Ray pneumoperitoneum</li></ul></div><div class="deck-card mgmt"><span class="deck-card-h">Management</span><ul><li>Exploratory laparotomy:<ul class="sub"><li>Duodenal ulcer Omental patch closure</li><li>Antral ulcer Partial distal gastrectomy</li></ul></li></ul></div></div><h4 class="deck-topic">Gastric cancer</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>General signs: Unintentional weight loss, loss of appetite, indigestion, Signs of anemia.</li><li>Palpable epigastric tumor, left supraclavicular adenopathy (Virchow node)</li><li>UGIB: Hematemesis, melena</li><li>Signs of gastric outlet obstruction: Vomiting, abdominal pain, early satiety</li></ul></div><div class="deck-card diag"><span class="deck-card-h">Diagnosis · best test</span><ul><li>EGD with biopsy Gold standard</li><li>Staging CT CAP with contrast, PET/CT</li></ul></div></div><h4 class="deck-topic">Indications of endoscopy</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>New onset of dyspepsia in patient &gt;60 years</li><li>Evidence of GI bleeding (Hematemesis, melena)</li><li>Iron deficiency anemia</li><li>Anorexia or unexplained weight loss</li><li>Persistent vomiting</li><li>Gastrointestinal cancer in 1 st degree relative</li><li>New onset of dyspepsia in patient &gt;60 years</li><li>Evidence of GI bleeding (Hematemesis, melena)</li><li>Iron deficiency anemia</li><li>Anorexia or unexplained weight loss</li><li>Persistent vomiting</li><li>Gastrointestinal cancer in 1 st degree relative</li></ul></div></div>
                </section>
            `,
            questions: [
                {
        ...
        },
        {
            ...
            summaryHtml: `
                ...
                <section class="topic deck-enrich">
                    <h3>Study-deck deep dive</h3>
                    <p class="deck-intro">Every comparison table, animated algorithm and clinical pearl from the high-yield SMLE deck for this topic.</p>
<div class="deck-block deck-tbl"><div class="deck-cap"><span class="deck-tag tag-tbl">Table</span> Post-operative infections — management</div><table><thead><tr><th>Complication</th><th>Management</th></tr></thead><tbody><tr><td><b>Surgical site infection (SSI)</b></td><td>Open the wound → CT to assess deep infection → percutaneous drainage under imaging</td></tr><tr><td><b>Wound abscess</b></td><td>Incision and drainage</td></tr><tr><td><b>Seroma (common after hernia repair; swelling without pain/fever/leukocytosis)</b></td><td>Wound exploration &amp; irrigation; leave wound open to prevent re-accumulation; regular dressing</td></tr><tr><td><b>Intra-abdominal collection</b></td><td>Small → antibiotics; ≥4×4 cm → percutaneous drainage; multiple collections → laparoscopy; unstable → laparotomy</td></tr></tbody></table></div><h4 class="deck-topic">Post operative fever</h4><div class="deck-cards"><div class="deck-card clin"><span class="deck-card-h">Clinical</span><ul><li>Sleeping on the stomach side</li><li>Soft bedding or overheating</li><li>Maternal smoke during pregnancy</li><li>Premature infant or low birth weight</li></ul></div><div class="deck-card mgmt"><span class="deck-card-h">Management</span><ul><li>Place baby on back to sleep (Best strategy)</li><li>Use a firm mattress</li><li>Keep sleeping area separate to the parents but in the same room</li><li>Pacifier at bed time</li></ul></div></div><h4 class="deck-topic">Pulmonary embolism</h4><div class="deck-cards"><div class="deck-card mgmt"><span class="deck-card-h">Management</span><ul><li>LMWH ( Enoxaparin ) incase of hemodynamic stable P.E.</li><li>Mechanical prophylaxis Incase of High risk bleeding but anticoagulation is required ( major surgery)</li><li>IVC filter incase of DVT/PE &amp; anticoagulation is contraindicated</li><li>Note: incase of Heparin induced thrombocytopenia:<ul class="sub"><li>Stop Heparin</li><li>Start lepirudin , Fondaparinux or DOACs</li></ul></li></ul></div></div>
                </section>
            `,
            questions: [
                {
