...
const Result = ({ answers, navigate, id, quizStartTime, questions, selectedTypes, selectedSource }) => {
  ...
  const handleContactUs = () => {
    ...
    window.location.href = 'mailto:alshraky3@gmail.com?subject=Subscription Inquiry&body=Hi, I completed the trial and would like to know more about the full version for 99SAR.';
  };
