...
const guides = [
    ...
    },
    {
        ...
        excerpt: 'مقارنة عملية بين طبيعة الأسئلة، أسلوب التفكير السريري، وإدارة الوقت بين SMLE وبرومترك مع خطة تنفيذية واضحة.'
    },
    {
        title: 'أهم مواضيع SMLE عالية العائد: كيف توزّع وقتك بذكاء؟',
        path: '/guides/smle-high-yield-topics',
        excerpt: 'خريطة أولويات للمواضيع الأكثر تأثيراً على الأداء، مع طريقة توزيع أسبوعية تقلل الهدر وتزيد نسبة الإجابات الصحيحة.'
    }
];
