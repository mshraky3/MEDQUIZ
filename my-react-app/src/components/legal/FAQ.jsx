    ...
    const faqs = [
        {
            ...
            answer: 'SQB (SMLE Question Bank) هي منصة تعليمية متخصصة في التحضير لاختبار الهيئة السعودية للتخصصات الصحية (SMLE) واختبار البرومترك. توفر المنصة بنك أسئلة شاملاً محدّثاً باستمرار مع تحليلات مفصلة وتتبع أداء شامل.'
        },
        {
            question: 'كم عدد الأسئلة المتاحة؟',
            answer: 'تحتوي المنصة على بنك أسئلة شامل يغطي جميع مواضيع وتخصصات الاختبار، تشمل Internal Medicine، Surgery، Pediatric، OB/GYN، والمزيد.'
        },
        {
