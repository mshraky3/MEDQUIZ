    ...
    const faqs = [
        {
            ...
            answer: 'SQB (SMLE Question Bank) هي منصة تعليمية متخصصة في التحضير لاختبار الهيئة السعودية للتخصصات الصحية (SMLE) واختبار البرومترك. توفر المنصة أكثر من 11,000 سؤال طبي مع تحليلات مفصلة وتتبع أداء شامل.'
        },
        {
            question: 'كم عدد الأسئلة المتاحة؟',
            answer: 'تحتوي المنصة على أكثر من 11,000 سؤال طبي تغطي أكثر من 40 تخصص طبي مختلف، تشمل Internal Medicine، Surgery، Pediatric، OB/GYN، والمزيد.'
        },
        {
            question: 'هل يمكنني تجربة المنصة مجاناً؟',
            answer: 'نعم. يمكنك إنشاء حساب مجاني والبدء مباشرة في التدريب. بعض المزايا المتقدمة قد تختلف حسب نوع الحساب.'
        },
        {
